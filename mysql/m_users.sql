...
(
    ...
    school_section          smallint(4)  COMMENT '学段(1：专科专业，2：本科专业，7：专硕专业，8：学硕专业)',
...
(
    ...
    school_id               VARCHAR(8)   COMMENT '学校ID',
    school_name             VARCHAR(64)  COMMENT '学校name',
    certificate_id          VARCHAR(16)  COMMENT '证书ID(包含研究生专业id、和考的专业证书id)',
    certificate_name        VARCHAR(16)  COMMENT '证书name(包含研究生专业名，证书名称)',
    type                    smallint(4)  COMMENT '证书类型(0：学生考的专业证书，1：专科学校学生证，2：本科学校学生证，7：专硕专业学生证，8：学硕专业学生证)',
